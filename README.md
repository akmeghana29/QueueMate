...
Users sign up and select a location or service.
Choose a time slot 3 hours prior and get live queue status.
User will be notified when 5 more tokens are left
Admins manage token numbers and control queues easily.
All data is securely handled to ensure privacy.
